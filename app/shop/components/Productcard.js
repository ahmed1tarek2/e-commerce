...
const Productcard = () => {
  ...
  return (
    <div className="rounded-md mt-2 border border-gray-200 grid grid-cols-4 gap-4">
      {items.map((pro, i) => {
        ...
        return (
          <div key={i} className="p-8 border border-gray-200 rounded-md">
            ...
            <p className="font-medium text-md mt-2">{pro.title}</p>
            ...
            <div className="flex items-center">
              ...
              <span className="text-gray-400 ml-2 text-sm">
                {Math.floor(pro.rating * 20)} مراجعة
              </span>
            </div>
